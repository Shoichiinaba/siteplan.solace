...
/* optional: background icon ikut berubah */
    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-1 fixed-start ms-2 "
        ...
        <div class="collapse navbar-collapse  w-auto h-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a <?= $this->uri->segment(1) == 'Customer_account' && $this->uri->segment(2) != 'Customer_account' && $this->uri->segment(2) != 'Customer_account' ? 'class="nav-link active"' : 'class="nav-link"' ?>
                        class="nav-link" href="<?php echo site_url('Customer_account'); ?> ">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        ...
                        <span class="nav-link-text ms-1">Data Akun Customer</span>
                    </a>
                </li>
            </ul>
        </div>
